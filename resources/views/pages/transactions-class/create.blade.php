...
@section('dashboard')
    <div class="p-6 space-y-6">
        <h2 class="text-xl font-bold mb-4">Tambahkan Kelas Transaksi</h2>

        <form action="{{ route('transactions-class.store') }}" method="POST" id="transactionForm">
            @csrf
            <input type="hidden" name="packageId" id="selectedPackage">

            {{-- Select User --}}
            <div class="mb-4">
                <label for="userId" class="block mb-2 font-medium">Pilih User</label>
            ...
            <div class="mb-2">
                <label for="packageSearch" class="block mb-1 font-medium">Cari Kelas </label>
