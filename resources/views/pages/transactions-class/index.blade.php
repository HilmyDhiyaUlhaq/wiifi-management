...
@section('dashboard')
    <div class="p-6 space-y-6">
        ...
        <div class="flex justify-between items-center mb-4">
            <form id="filterForm" method="GET" action="{{ route('transactions-class.index') }}" class="flex gap-2 w-full">
                <!-- Dropdown Per Page -->
                ...
                <a type="submit" name="action" value="export"
                    href="{{ route('transactions-class.export', ['startDate' => $data['startDate'], 'endDate' => $data['endDate']]) }}"
