        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form action="{{ route('class.update', $class->id) }}" method="POST">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm">Perbarui</button>
                </div>
            </form>
        </div>
    </div>
