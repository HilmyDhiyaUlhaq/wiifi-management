    ...
    <div class="p-6 space-y-6">
        <div>
            <a href="{{ route('users.transactions.index', ['userId' => $user->id]) }}"
                class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm">Transaction</a>
            <a href="{{ route('users.wifis.accounts.index', ['userId' => $user->id]) }}"
                class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm">Wifi accounts</a>
        </div>
