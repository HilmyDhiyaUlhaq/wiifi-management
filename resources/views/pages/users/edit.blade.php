    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <!-- Email -->
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Alaman Email</label>
                ...
                <!-- Role -->
                <div>
                    <label for="role" class="block mb-2 text-sm font-medium text-gray-900">Peran</label>
                ...
                <div>
                    ...
                    <select id="status" name="status" required
                        ...
                        <option value="active" {{ old('status', $user->userWifi?->status) == 'active' ? 'selected' : '' }}>Aktif</option>
                        <option value="inactive" {{ old('status', $user->userWifi?->status) == 'inactive' ? 'selected' : '' }}>Inaktif</option>
                    </select>
            ...
            <div class="mb-6">
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Password Baru (Biarkan kosong bila tidak diubah)</label>
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('users.index') }}" class="px-5 py-2.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm font-medium">Batalkan</a>
