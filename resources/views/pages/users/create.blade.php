...
@section('dashboard')
    <div class="p-6">
        <div class="bg-white shadow rounded-lg p-6">
            <h1 class="text-2xl font-bold mb-6">Tambahkan pengguna baru</h1>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <!-- Email -->
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Email
                            </label>
